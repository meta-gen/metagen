...
public class TableDesignServiceImpl implements TableDesignService {
    ...
    @Override
    public Page<TableDesign> selectTableData(Pageable pageable, AccountDto accountDto, String searchColumn, String searchQuery) {
        Long projectId = accountDto.getProjectId();

        return tableDesignRepository.findAllByProjectId(projectId, pageable);
    }
}
