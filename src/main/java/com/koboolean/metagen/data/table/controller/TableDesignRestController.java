...
public class TableDesignRestController {
    ...
    public ResponseEntity<Map<String,Object>> selectTableData(
        ...
        Page<TableDesign> tableDesigns = tableDesignService.selectTableData(pageable, accountDto, searchColumn, searchQuery);
